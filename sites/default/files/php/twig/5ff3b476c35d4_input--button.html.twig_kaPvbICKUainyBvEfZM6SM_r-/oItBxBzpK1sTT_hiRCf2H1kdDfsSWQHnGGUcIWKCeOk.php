...
class __TwigTemplate_25bd748644c90bf864285576424e603a8d1008009c6aedd41da52a2d78ec861c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap/templates/input/input--button.html.twig", "C:\\xampp\\htdocs\\drupal9\\themes\\contrib\\bootstrap\\templates\\input\\input--button.html.twig");
    }
